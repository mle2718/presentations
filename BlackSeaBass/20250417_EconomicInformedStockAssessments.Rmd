...
Exploratory data analysis step: Do prices vary by size? Estimate a simple hedonic model, the price of a pound of fish is a function of:
...
Assumption 2 - Dealers have diverse but persistent tendencies in terms of how they classify fish
  ...
  - Dealer ID should go into the model as a factor variable
      ...
      - Implications for Tuning and training: do a "group" split and $k-$fold  `r Cite(myBib, "Strobl2007")`
...
.footnote[
mtry: The number of randomly selected parameters that go into the Classification Tree.
