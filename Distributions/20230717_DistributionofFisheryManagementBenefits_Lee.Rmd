...
<img src="./images/SBEs_at_NOAA.png" alt="Approximately 1\% of the NOAA workforce are social scientists" width="auto" height="300"  />

- At Fisheries, there are approximately 15 social scientists and 50 economists.  Economists have the tools to tell only a small part of any equity story.
...
- **Issue** : Can't disaggregate "recreational anglers."
- **Issue** : 
- **Lessons Learned** : 
]
.pull-right[
...
- More sophisticated or dissagregated metrics? 
    - Not really
    - They know that we have limited ability to provide this information
...
- Processing plant labor are often from a group that are hard to reach
- Office of Management and Budget's PRA Process is onerous 
