...
.pull-left[
Datastreams primarily designed for assessing stocks of fish and repurposed for economic analysis. Hard to examine distributions and only covers the harvest sector.
...
.pull-right[
<img src="./images/owners1.png" alt="Owner survey included information about sustainability" width="auto" height="220" />
<img src="./images/owners_education.png" alt="Owner survey included information about Owner's Education" width="auto" height="220" />
]
...
- Population: Communities and groups that are underrepresented in fisheries and fisheries management using a power-sharing data collection approach
    - crew
    - shoreside workers
    - immigrants
    - processing workers
...
Under-Valued
  ...
  - "Nobody is going to use this information anyway."
...
- Representativeness
  ...
  - Scientific staff not diverse or at least similar to the community
...
## Are there socioeconomic data collection efforts have been tried and have failed?
.pull-left[
 - Vessel owners were upset at the inclusion of demographic questions during survey pretesting for 2022. Demographics section was removed 
- Social Capital survey 
  - not approved by OMB
  - not boosted by Fisheries Leadership
