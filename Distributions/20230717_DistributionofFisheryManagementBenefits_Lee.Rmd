...
knitr::kable(data_overview, linesep = "",
      ...
      caption = "Ongoing Data Collections at NEFSC",
      #align = 'c',
      booktabs = T) %>%
...
.contrib[
More \* means more assumptions and data processing.]
]
...
`r Cite(myBib, "Henry2014")` and `r Cite(myBib, "cutler2022tracking")`
]
...
- People who don't show up to Council meetings
  - Low expected gains from attending a costly meeting `r Cite(myBib, "turner2005meetings")`
  - 
...
- Although common in US Fisheries, an initial allocation does not *need* to be based on fishing history.
  - Politically expedient `r Cite(myBib, "holzer2015property")`
  - Has participation and equity implications that 
      - Are long-lasting
      - Reinforced by Council process (See `r Cite(myBib, "turner2005meetings")`)
