...
.remark[Figure 3 from `r Citet(myBib, c("Mazur2023"))`: SSB, F, and Catch for Gulf of Maine Cod and Georges Bank haddock for a variety of uncertainty and harvest control rules.]
...
.remark[There's just so much noise.]
.footnote[
Model 1: An economic model. Model 3: No implementation error.  

Model 4: Implementation error params estimated from Model 1.  Model 6: IE params from Model 1, but using at constant F HCR.
]
...
- Explore different scenarios?
  ...
  - Back to Days-at-Sea management?
  - Climate change affecting recruitment?
- Different performance metrics?
- A disaggregated (vessel-level) model in which firms choose which ports to utilize.  This brings us a step closer to including effects on communities.
