...
A disaggregated (vessel-level) model in which firms choose which ports to utilize.
  ...
  -  Understanding structure underlying fishers' decisions allows us to better predict how fishing activity and landings will redistribute in response to policy changes or exogenous shocks
